...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        ### Forward pass ###
        # Hidden layer
        hidden_inputs = X[None, :].dot(self.weights_input_to_hidden)  # signals into hidden layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # Output error
        error = y - final_outputs[0, 0] # Output layer error is the difference between desired target and actual output.
        
        # Calculate the hidden layer's contribution to the error
        hidden_error = self.weights_hidden_to_output.dot(error)
        
        # Backpropagated error terms
        output_error_term = error.reshape(1,1)
